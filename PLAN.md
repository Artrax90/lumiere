...
| Видеоплеер | ⚠️ Фаза 4 (HLS.js + FFmpeg, перемотка в пределах буфера) |
| TorrServer интеграция | ✅ Фаза 4 |
| JacRed интеграция | ✅ Фаза 4 (удалённый API) |
| Субтитры | ❌ Не работают |
| Мульти-аудио | ❌ Только первая дорожка |
| Синхронизация | ❌ Фаза 5 не сделана |
| Локализация (i18n) | ❌ Фаза 6 не сделана |
| Android (Capacitor) | ❌ Фаза 5 не сделана |
| Tizen/webOS виджеты | ❌ Фаза 5 не сделана |
| WAF + GeoIP | ❌ Фаза 6 не сделана |
| DLNA | ❌ Фаза 7 не сделана |
| AdminPanel | ❌ Фаза 7 не сделана |
