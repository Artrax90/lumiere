...
const animeGenres = ['Экшн', 'Приключения', 'Фэнтези', 'Драма', 'Фантастика', 'Повседневность', 'Детектив', 'Романтика'];
      ...
      <div className="mx-auto max-w-[1500px]">
        <div className="mb-10 animate-row-reveal">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-display text-[36px] font-medium tracking-tight text-white/95 md:text-[44px]">Аниме</h1>
          </div>
          <p className="mt-2 text-[15px] text-white/50">Стилизованные миры, нарисованные мечты.</p>
        </div>
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 p-8 lg:p-10">
              <div className="mb-2 flex items-center gap-2">
                <span className="rounded-full bg-rose-300/15 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.12em] text-rose-200/90">Рекомендуем</span>
        ...
        <section className="mb-12 animate-row-reveal">
          <div className="mb-5 flex items-center gap-3">
            ...
            <h2 className="text-display text-[21px] font-medium tracking-tight text-white/88">Популярное</h2>
        ...
        <section className="mb-12 animate-row-reveal">
          <div className="mb-5 flex items-center gap-3">
            ...
            <h2 className="text-display text-[21px] font-medium tracking-tight text-white/88">Топ рейтинг</h2>
            <div className="h-px flex-1 bg-white/[0.06]" />
          </div>
          <div className="no-scrollbar flex gap-5 overflow-x-auto pb-4">
